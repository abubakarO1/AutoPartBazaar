...
const loadBackLights = (modelPath) => {
  ...
  const parts = {
    tyres: [
      { name: 'Sport Tyres', price: 1200, img: '/images/sports_tires.jpg', model: '/models/tire.glb' },
      { name: 'Alloy rims', price: 1400, img: '/svgs/tyre.svg', model: '/models/tire1.glb' },
    ],
    frontBumpers: [
      { name: 'Front Bumper', price: 1500, img: '/svgs/bumper.svg', model: '/models/civicfbumper.glb' },
      { name: 'Front Bumper V2', price: 1700, img: '/svgs/bumper.svg', model: '/models/civicfbumper1.glb' },
  ],  
    rearBumpers: [
      { name: 'Rear Bumper', price: 1300, img: '/svgs/bumper.svg' },
      { name: 'Rear Bumper V2', price: 1500, img: '/svgs/bumper.svg' },
      { name: 'Rear Bumper V3', price: 1700, img: '/svgs/bumper.svg' }
    ],
    frontLights: [
