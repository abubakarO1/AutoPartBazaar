...
//   return (
//     <Link key={product.productId} href={`/pages/productdetail`}>
//       <div
//         className={`bg-gray-800 border border-gray-400 rounded-lg overflow-hidden shadow-lg ${
//           viewMode === "list" ? "flex items-center space-x-4" : ""
//         }`}
//       >
//         {/* Ensure image loads correctly from S3 or a fallback */}
//         <div className={`w-full h-48 flex justify-center items-center bg-gray-700`}>
//           <img
//             src={product.imageUrl || '/images/car1.jpg'} // Fallback to placeholder if imageUrl is missing
//             alt={product.name}
