...
const ProductCard = ({ product, viewMode }) => {
  return (
    <Link href={`/productdetail/${product.productId}`}> {/* ✅ Fixed the link */}
      <div className={`bg-gray-900 border border-gray-400 rounded-lg overflow-hidden shadow-lg ${viewMode === "list" ? "flex items-center space-x-4" : ""}`}>
        <div className="w-full h-48 flex justify-center items-center bg-gray-800">
          <img
